...
static public partial class clsUtility
{
    ...
    static public ArrayList _patarnMatch(string str, string patarn, int kakko = -1, int kakko2 = -1,
        RegexOptions regOp = RegexOptions.Singleline)
    {
        //正規表現パターンとオプションを指定してRegexオブジェクトを作成
        Regex r = new Regex(patarn, regOp);
    ...
    */
    ...
    /// アプリを終了させる
    /// </summary>
    static public void _appEnd()
    {
        Environment.Exit(0);
    }
    
    
    public static string _getProgramLine(string memo = "")
    {
